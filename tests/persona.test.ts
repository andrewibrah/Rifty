...
const baseState: PersonalizationState = {
  ...
  cadence: "daily",
  goals: ["health", "custom-goal-example"],
  extra_goal: null,
  // custom_goals: [],
...
console.assert(
  computePersonaTag(architectState) === "Architect",
  "Architect tag mismatch"
);
console.assert(
  computePersonaTag(explorerState) === "Explorer",
  "Explorer tag mismatch"
);
console.assert(
  computePersonaTag(anchorState) === "Anchor",
  "Anchor tag mismatch"
);
console.assert(
  computePersonaTag(acceleratorState) === "Accelerator",
  "Accelerator tag mismatch"
);
console.assert(
  computePersonaTag(baseState) === "Generalist",
  "Generalist fallback mismatch"
);
