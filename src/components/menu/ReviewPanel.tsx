...
import { generateWeeklyReview, type WeeklyReviewReport } from '../../services/review'
...
const ReviewPanel: React.FC<ReviewPanelProps> = ({
  ...
  const loadStats = useCallback(async () => {
    ...
    try {
      ...
      const journalCount = entries.filter((entry) => entry.type === 'journal').length
      const scheduleCount = entries.filter((entry) => entry.type === 'schedule').length
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <TouchableOpacity onPress={loadReview} style={styles.refreshButton}>
      ...
      >
        <View style={styles.metricsRow}>
          {renderCard('Journals', counts.journals, 'book-outline', onOpenJournals)}
          {renderCard('Goals', counts.goals, 'flag-outline', onOpenGoals)}
          {renderCard('Schedules', counts.schedules, 'calendar-outline', onOpenSchedules)}
          {renderCard('Atomic Moments', counts.moments, 'sparkles-outline', onOpenMoments)}
        </View>
